<script lang="ts">
  ...
  import type { IGridProps } from '$lib/common/interfaces/grid.interface';
  import { columnsPrecipcionList, dataSource } from "$lib/common/mock/prescriptions";

	let pathname = '';
  page.subscribe(res => { pathname = res.path });
