<script lang="ts">
  ...
  let location = '';
  page.subscribe(res => { location = res.path });
      ...
      <ul class="md:flex-col md:min-w-full flex flex-col list-none">
        ...
        <li class="items-center">
          <a
            ...
            class="text-xs uppercase py-3 font-bold block {location == '/admin/recetas-medicas' ? 'text-red-500 hover:text-red-600':'text-blueGray-700 hover:text-blueGray-500'}"
          >
            <i
              class="fas fa-notes-medical mr-2 text-sm {location == '/admin/recetas-medicas'  ? 'opacity-75' : 'text-blueGray-300'}"
            ></i>
            Recetas médicas
          </a>
        </li>
        { #if usuario.rol === 'admin'}
          <li class="items-center">
            <a
              href="/admin/doctores"
              class="text-xs uppercase py-3 font-bold block {location == '/admin/doctores'  ? 'text-red-500 hover:text-red-600':'text-blueGray-700 hover:text-blueGray-500'}"
            >
              <i
                class="fas fa-user-md mr-2 text-sm {location == '/admin/doctores' ? 'opacity-75' : 'text-blueGray-300'}"
              ></i>
              Doctores
            </a>
          </li>    
        ...
        <li class="items-center">
          <a
            ...
            class="text-xs uppercase py-3 font-bold block {location == '/admin/dashboard' ? 'text-red-500 hover:text-red-600':'text-blueGray-700 hover:text-blueGray-500'}"
          >
            <i
              class="fas fa-tv mr-2 text-sm {location == '/admin/dashboard' ? 'opacity-75' : 'text-blueGray-300'}"
            ></i>
            Dashboard
          </a>
        </li>
